...
export class OrdersService {
    ...
    private readonly validTransitions: Record<OrderStatus, OrderStatus[]> = {
        [OrderStatus.PENDING_APPROVAL]: [OrderStatus.APPROVED, OrderStatus.REJECTED, OrderStatus.AWAITING_PAYMENT_VERIFICATION],
        ...
        [OrderStatus.READY_FOR_BILLING]: [OrderStatus.AWAITING_PAYMENT_VERIFICATION],
        [OrderStatus.AWAITING_PAYMENT_VERIFICATION]: [OrderStatus.PAID, OrderStatus.REJECTED],
