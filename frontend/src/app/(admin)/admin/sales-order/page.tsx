...
const ordersData = [
  {
    ...
    paymongoTransactionId: "TXN-2026-03-05-001",
    paymongoAmount: 87500,
    paymongoPaymentMethod: "gcash",
    paymongoTimestamp: "2026-03-05T14:30:00Z",
  },
  {
    id: "2",
    ...
    status: "Delivered",
    paymentMethod: "paymongo" as const,
    paymongoTransactionId: "TXN-2026-03-04-002",
    paymongoAmount: 142300,
    paymongoPaymentMethod: "card",
    paymongoTimestamp: "2026-03-04T11:15:00Z",
  },
  {
    id: "3",
    ...
    paymentProofImage: "https://images.unsplash.com/photo-1633356122544-f134324ef6db?w=500&h=500&fit=crop",
    paymentProofUploadedAt: "2026-03-03T14:30:00Z",
  },
  {
    id: "4",
    ...
    status: "Billed",
    paymentMethod: "paymongo" as const,
    paymongoTransactionId: "TXN-2026-03-02-003",
    paymongoAmount: 28776,
    paymongoPaymentMethod: "grab_pay",
    paymongoTimestamp: "2026-03-02T09:45:00Z",
  },
  {
    id: "5",
    ...
    paymentMethod: "manual_transfer" as const,
    paymentProofImage: "https://images.unsplash.com/photo-1579621970563-430f63602022?w=500&h=500&fit=crop",
    paymentProofUploadedAt: "2026-03-01T10:15:00Z",
  },
  {
    id: "6",
    ...
    status: "Billed",
    paymentMethod: "paymongo" as const,
    paymongoTransactionId: "TXN-2026-02-28-004",
    paymongoAmount: 96450,
    paymongoPaymentMethod: "card",
    paymongoTimestamp: "2026-02-28T16:20:00Z",
  },
];
...
export default function SalesOrdersPage() {
  ...
  const handleApprovePayment = async (order: SalesOrder) => {
    ...
    try {
      console.log("Approving payment for order:", order.orderNumber);
  ...
  const handleRejectPayment = async (order: SalesOrder) => {
    setPaymentProofLoading(true);
    try {
      console.log("Rejecting payment for order:", order.orderNumber);
      await new Promise((resolve) => setTimeout(resolve, 1000));
  ...
  const handleMarkAsReadyForDelivery = async (order: SalesOrder) => {
    ...
    try {
      console.log("Marking order as ready for delivery:", order.orderNumber);
      await new Promise((resolve) => setTimeout(resolve, 1000));
      console.log("Order marked as ready for delivery");
  ...
  const handleReportDiscrepancy = async (order: SalesOrder) => {
    setPaymongoTransactionLoading(true);
    try {
      console.log("Reporting discrepancy for order:", order.orderNumber);
      await new Promise((resolve) => setTimeout(resolve, 1000));
      console.log("Discrepancy reported - flagged for manual review");
      setPaymongoTransactionOrder(null);
    } catch (error) {
  ...
  return (
    <div className="space-y-6 px-8 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h1 className="text-gray-900 font-bold text-2xl">Sales Orders — SAP SD</h1>
