...
const nav = [
  { label: "Home", path: "/b2b/home" },
  {
    label: "Products",
    children: [
      { label: "All Products", path: "/b2b/products/all" },
      { label: "Bakeware", path: "/b2b/products/bakeware" },
      { label: "Cookware", path: "/b2b/products/cookware" },
      { label: "Dinnerware", path: "/b2b/products/dinnerware" },
      { label: "Glassware", path: "/b2b/products/glassware" },
      { label: "Hydration", path: "/b2b/products/hydration" },
      { label: "Vacuum Flask", path: "/b2b/products/vacuum-flask" },
    ],
  },
