...
export type GetClientOrdersQuery = { __typename?: 'Query', clientOrders: Array<{ __typename?: 'OrdersTbl', orderId: number, orderNumber?: string | null, productId: number, userId: number, orderType?: string | null, quantity: number, unitPrice: number, totalPrice: number, deliveryFee?: number | null, grandTotal?: number | null, status: string, deliveryStatus?: string | null, paymentProofImage?: string | null, paymentProofStatus?: string | null, paymentProofRejectionReason?: string | null, paymentProofAttempts: number, paymongoTransactionId?: string | null, createdAt: any, updatedAt: any }> };
...
export type GetOrderDetailsQuery = { __typename?: 'Query', orderDetails: { __typename?: 'OrdersTbl', orderId: number, orderNumber?: string | null, productId: number, userId: number, orderType?: string | null, quantity: number, unitPrice: number, totalPrice: number, deliveryFee?: number | null, grandTotal?: number | null, status: string, deliveryStatus?: string | null, paymentProofImage?: string | null, paymentProofStatus?: string | null, paymentProofRejectionReason?: string | null, paymentProofAttempts: number, paymongoTransactionId?: string | null, createdAt: any, updatedAt: any } };
