 ...
 */
function mapOrderStatus(status: string): "PENDING_APPROVAL" | "APPROVED" | "REJECTED" | "CANCELLED" | "ORDERED_FROM_SUPPLIER" | "READY_FOR_BILLING" | "AWAITING_PAYMENT_VERIFICATION" | "PAID" | "DELIVERED" {
